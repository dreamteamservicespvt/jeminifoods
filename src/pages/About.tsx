  ...
  const fallbackTeam = [
    {
      ...
      bio: "With over 25 years of culinary expertise, Chef Jemini brings innovative techniques to classic fine dining.",
      featured: true
    },
    {
      id: "2",
  ...
  const fallbackTimeline = [
    {
      ...
      year: "2001",
      title: "The Beginning",
      description: "Chef Marcus Jemini opens the doors to what would become one of the most celebrated dining establishments.",
    ...
    },
    {
      ...
      description: "Jemini Foods receives its first major culinary award, establishing its place in the fine dining scene.",
    ...
    },
    {
      ...
      year: "2018",
      title: "Michelin Star",
      description: "Jemini Foods is awarded its first Michelin star, a testament to our relentless pursuit of excellence.",
          ...
          <div className="grid lg:grid-cols-5 gap-16 items-center">
            ...
            >
              <h2 className="text-6xl font-serif font-bold text-amber-400 mb-10 leading-tight">
                The Vision <br/>
                <span className="text-cream/80 text-5xl">Behind Jemini Foods</span>
              </h2>
              ...
              <div className="border-l-2 border-amber-500/40 pl-8 py-2 mb-8">
                <p className="text-cream text-xl leading-relaxed mb-6 font-serif">
                  Founded in 2001, Jemini Foods began as a dream to create more than just a restaurant—
                ...
                <p className="text-cream/80 text-lg leading-relaxed mb-6">
                  Chef Marcus Jemini, with his classical French training and innovative spirit, 
            ...
            >
              <div className="relative z-10 overflow-hidden">                {/* Featured chef image */}
                {team.find(member => member.featured)?.image ? (
                  <img
                    src={team.find(member => member.featured)?.image}
                    alt="Chef Marcus Jemini"
              ...
              >
                ...
                <p className="text-cream/80 text-sm">
                  With over 25 years of culinary expertise, Chef Jemini brings innovative
                ...
                <div className="order-2 md:order-1">
                  ...
                  <p className="text-cream leading-relaxed mb-6">
                    {timeline[activeTimelineIndex]?.description || 
                      'Chef Marcus Jemini opens the doors to what would become one of the most celebrated dining establishments.'}
                  </p>
              ...
              >
                <div className="bg-black/40 backdrop-blur-md border border-amber-600/20 rounded-lg p-12">
                  ...
                  <div className="mt-12">
                    ...
                    <p className="text-cream/80 leading-relaxed">
                      At Jemini Foods, we're not just serving meals; we're crafting experiences that will be remembered 
