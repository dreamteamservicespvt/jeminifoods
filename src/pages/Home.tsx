...
const Home = () => {
  ...
  const testimonials = [
    ...
    {
      text: "Chef Jemini has created something magical here. A sensory journey that balances innovation with deep respect for tradition.",
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-cream text-lg leading-relaxed">
                For over five years, Jemini Foods has been a beacon of culinary excellence, 
