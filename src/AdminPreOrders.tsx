...
const AdminPreOrders = () => {
  ...
  const getEmailSubject = (status: string) => {
    switch (status) {      case "ready": return "Your Order is Ready for Pickup! - Jemini Foods";
      case "in kitchen": return "Your Order is Being Prepared - Jemini Foods";
      case "rejected": return "Important Information About Your Order - Jemini Foods";
      case "completed": return "Thank You for Your Order - Jemini Foods";
      default: return "Order Update - Jemini Foods";
    }
  };
  ...
  const getEmailBody = (order: PreOrder, status: string) => {
    ...
    message += `Thank you for choosing Jemini Foods!\n`;
